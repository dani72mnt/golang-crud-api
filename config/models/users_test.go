...
var (
	userDBTypes = map[string]string{`ID`: `integer`, `Name`: `character varying`, `Family`: `character varying`, `Email`: `character varying`, `Password`: `text`, `CreatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
